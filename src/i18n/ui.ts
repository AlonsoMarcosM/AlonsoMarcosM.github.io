...
export const ui = {
  es: {
    ...
    'section.projects': 'Big Data y cloud aplicados',
    'section.projects.subtitle': 'Proyectos académicos aplicados con arquitectura, ejecución, evidencias y limitaciones',
    ...
    'projects.technicalDocs': 'Documentación técnica',
    'projects.architecture': 'Arquitectura',
    'projects.problem': 'Problema',
    'projects.dataFlow': 'Flujo de datos',
    'projects.ownership': 'Contribución y autoría',
    'projects.evidence': 'Evidencias',
    'projects.limitations': 'Limitaciones',
  ...
  en: {
    ...
    'section.projects': 'Applied Big Data and cloud',
    'section.projects.subtitle': 'Applied academic projects with architecture, execution evidence and limitations',
    ...
    'projects.liveDemo': 'Live Demo',
    'projects.technicalDocs': 'Technical documentation',
    'projects.architecture': 'Architecture',
    'projects.problem': 'Problem',
    'projects.dataFlow': 'Data flow',
    'projects.ownership': 'Contribution and authorship',
    'projects.evidence': 'Evidence',
    'projects.limitations': 'Limitations',
